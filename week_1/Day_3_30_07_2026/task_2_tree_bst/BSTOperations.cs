...
namespace BinarySearchTree
{
    ...
    class Node
    {
        ...
        /// <summary>
        /// Initializes a new Binary Search Tree node
    ...
    class BSTOperations
    {
        ...
        /// <summary>
        /// Searches for a specified value in the
        /// Binary Search Tree.
        /// </summary>
        public bool Search(Node root, int value)
        {
            ...
            // Return true if the value matches the current node.
            if (root.Data == value)
                return true;

            // Search the left subtree if the value is smaller.
            if (value < root.Data)
